...
#include "..\headers\NeHeGL.h"												// Header File For NeHeGL
...
BOOL Initialize(GL_Window* window, Keys* keys)					// Any OpenGL Initialization Goes Here
{
	...
	if ((!LoadTGA(&textures[0], const_cast<char*>("data/BlueFace.tga"))) ||			// Load The BlueFace Texture
		(!LoadTGA(&textures[1], const_cast<char*>("data/Bucket.tga"))) ||			// Load The Bucket Texture
		(!LoadTGA(&textures[2], const_cast<char*>("data/Target.tga"))) ||			// Load The Target Texture
		(!LoadTGA(&textures[3], const_cast<char*>("data/Coke.tga"))) ||				// Load The Coke Texture
		(!LoadTGA(&textures[4], const_cast<char*>("data/Vase.tga"))) ||				// Load The Vase Texture
		(!LoadTGA(&textures[5], const_cast<char*>("data/Explode.tga"))) ||			// Load The Explosion Texture
		(!LoadTGA(&textures[6], const_cast<char*>("data/Ground.tga"))) ||			// Load The Ground Texture
		(!LoadTGA(&textures[7], const_cast<char*>("data/Sky.tga"))) ||				// Load The Sky Texture
		(!LoadTGA(&textures[8], const_cast<char*>("data/Crosshair.tga"))) ||		// Load The Crosshair Texture
		(!LoadTGA(&textures[9], const_cast<char*>("data/Font.tga"))))				// Load The Crosshair Texture
	{
