...
1. [Learn C++](https://learn.microsoft.com/en-us/cpp/cpp/?view=msvc-170) and [Visual Studio for C++](https://learn.microsoft.com/en-us/cpp/build/projects-and-build-systems-cpp?view=msvc-170)
   * [CPP_Beginner_to_Expert](https://github.com/tridibsamanta/CPP_Beginner_to_Expert), [cpluspluscourse](https://github.com/hsf-training/cpluspluscourse), [Cpp-Tutorial-Samples](https://github.com/sinairv/Cpp-Tutorial-Samples) and [modern-cpp-tutorial](https://github.com/changkun/modern-cpp-tutorial)
